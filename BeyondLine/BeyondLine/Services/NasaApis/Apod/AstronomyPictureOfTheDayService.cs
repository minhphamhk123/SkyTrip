...
namespace NasaApiExplorer.Services.NasaApis.Apod
{
    ...
    public class AstronomyPictureOfTheDayService : IAstronomyPictureOfTheDayService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<AstronomyPictureOfTheDay> GetAstronomyPictureOfTheDayAsync(string dateToGo)
        {
            var requestUri = string.Format(
                    "https://api.nasa.gov/planetary/apod?api_key={0}{1}",
                    StaticKeys.API_KEY, dateToGo);
